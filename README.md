...
```bash
yarn workspace @ccg/app-single-comp start
```
...
```json
"scripts": {
    "start:app-ant-design": "yarn workspace @ccg/app-ant-design-rewired start",
    "start:app-multi": "yarn workspace @ccg/app-multi-comps start",
    "start:app-single": "yarn workspace @ccg/app-single-comp start",
    "start:app-ts": "yarn workspace @ccg/app-typescript start",
    "start:storybook": "yarn workspace @ccg/storybook storybook",
    "start:storybook-ts": "yarn workspace @ccg/storybook-typescript storybook",
    ...
  }
```
